...
## [Missing public directory](https://vercel.com/docs/errors/error-list\#missing-public-directory) [Copy link to section](https://vercel.com/docs/errors/error-list\#missing-public-directory)
...
## [Missing build script](https://vercel.com/docs/errors/error-list\#missing-build-script) [Copy link to section](https://vercel.com/docs/errors/error-list\#missing-build-script)
...
## [Maximum team member requests](https://vercel.com/docs/errors/error-list\#maximum-team-member-requests) [Copy link to section](https://vercel.com/docs/errors/error-list\#maximum-team-member-requests)
...
## [Inviting users to team who requested access](https://vercel.com/docs/errors/error-list\#inviting-users-to-team-who-requested-access) [Copy link to section](https://vercel.com/docs/errors/error-list\#inviting-users-to-team-who-requested-access)
...
## [Request access with the required Git account](https://vercel.com/docs/errors/error-list\#request-access-with-the-required-git-account) [Copy link to section](https://vercel.com/docs/errors/error-list\#request-access-with-the-required-git-account)
...
If the committer has a Vercel account and manual approval is enabled, a [team Owner](https://vercel.com/docs/rbac/access-roles#owner-role) must approve their membership in [team settings](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fsettings%2Fmembers&title=Collaboration+Settings).

If the committer does not have a Vercel account, they must create one and link their Git provider.

## [Blocked scopes](https://vercel.com/docs/errors/error-list\#blocked-scopes) [Copy link to section](https://vercel.com/docs/errors/error-list\#blocked-scopes)
...
## [Unused build and development settings](https://vercel.com/docs/errors/error-list\#unused-build-and-development-settings) [Copy link to section](https://vercel.com/docs/errors/error-list\#unused-build-and-development-settings)
...
## [Unused Vercel Function region setting](https://vercel.com/docs/errors/error-list\#unused-vercel-function-region-setting) [Copy link to section](https://vercel.com/docs/errors/error-list\#unused-vercel-function-region-setting)
...
## [Invalid route source pattern](https://vercel.com/docs/errors/error-list\#invalid-route-source-pattern) [Copy link to section](https://vercel.com/docs/errors/error-list\#invalid-route-source-pattern)
...
## [Invalid route destination segment](https://vercel.com/docs/errors/error-list\#invalid-route-destination-segment) [Copy link to section](https://vercel.com/docs/errors/error-list\#invalid-route-destination-segment)
...
## [Failed to install builder dependencies](https://vercel.com/docs/errors/error-list\#failed-to-install-builder-dependencies) [Copy link to section](https://vercel.com/docs/errors/error-list\#failed-to-install-builder-dependencies)
...
## [Conflicting configuration files](https://vercel.com/docs/errors/error-list\#conflicting-configuration-files) [Copy link to section](https://vercel.com/docs/errors/error-list\#conflicting-configuration-files)
...
## [Conflicting functions and builds configuration](https://vercel.com/docs/errors/error-list\#conflicting-functions-and-builds-configuration) [Copy link to section](https://vercel.com/docs/errors/error-list\#conflicting-functions-and-builds-configuration)
...
## [Unsupported functions configuration with Nextjs](https://vercel.com/docs/errors/error-list\#unsupported-functions-configuration-with-nextjs) [Copy link to section](https://vercel.com/docs/errors/error-list\#unsupported-functions-configuration-with-nextjs)
...
## [Deploying Vercel functions to multiple regions](https://vercel.com/docs/errors/error-list\#deploying-vercel-functions-to-multiple-regions) [Copy link to section](https://vercel.com/docs/errors/error-list\#deploying-vercel-functions-to-multiple-regions)
...
## [Unmatched function pattern](https://vercel.com/docs/errors/error-list\#unmatched-function-pattern) [Copy link to section](https://vercel.com/docs/errors/error-list\#unmatched-function-pattern)
...
## [Cannot load project settings](https://vercel.com/docs/errors/error-list\#cannot-load-project-settings) [Copy link to section](https://vercel.com/docs/errors/error-list\#cannot-load-project-settings)
...
## [Project name validation](https://vercel.com/docs/errors/error-list\#project-name-validation) [Copy link to section](https://vercel.com/docs/errors/error-list\#project-name-validation)
...
## [Repository connection limitation](https://vercel.com/docs/errors/error-list\#repository-connection-limitation) [Copy link to section](https://vercel.com/docs/errors/error-list\#repository-connection-limitation)
...
## [Domain verification through CLI](https://vercel.com/docs/errors/error-list\#domain-verification-through-cli) [Copy link to section](https://vercel.com/docs/errors/error-list\#domain-verification-through-cli)
...
## [Leaving the team](https://vercel.com/docs/errors/error-list\#leaving-the-team) [Copy link to section](https://vercel.com/docs/errors/error-list\#leaving-the-team)
...
## [Git Default ignore list](https://vercel.com/docs/errors/error-list\#git-default-ignore-list) [Copy link to section](https://vercel.com/docs/errors/error-list\#git-default-ignore-list)
...
## [GitHub app installation not found](https://vercel.com/docs/errors/error-list\#github-app-installation-not-found) [Copy link to section](https://vercel.com/docs/errors/error-list\#github-app-installation-not-found)
...
## [Preview branch used as production branch](https://vercel.com/docs/errors/error-list\#preview-branch-used-as-production-branch) [Copy link to section](https://vercel.com/docs/errors/error-list\#preview-branch-used-as-production-branch)
...
## [Lost Git repository access](https://vercel.com/docs/errors/error-list\#lost-git-repository-access) [Copy link to section](https://vercel.com/docs/errors/error-list\#lost-git-repository-access)
...
## [Production deployment cannot be redeployed](https://vercel.com/docs/errors/error-list\#production-deployment-cannot-be-redeployed) [Copy link to section](https://vercel.com/docs/errors/error-list\#production-deployment-cannot-be-redeployed)
...
## [SSL certificate deletion denied](https://vercel.com/docs/errors/error-list\#ssl-certificate-deletion-denied) [Copy link to section](https://vercel.com/docs/errors/error-list\#ssl-certificate-deletion-denied)
...
## [Production branch used as preview branch](https://vercel.com/docs/errors/error-list\#production-branch-used-as-preview-branch) [Copy link to section](https://vercel.com/docs/errors/error-list\#production-branch-used-as-preview-branch)
...
## [Command not found in vercel dev](https://vercel.com/docs/errors/error-list\#command-not-found-in-vercel-dev) [Copy link to section](https://vercel.com/docs/errors/error-list\#command-not-found-in-vercel-dev)
...
## [Recursive invocation of commands](https://vercel.com/docs/errors/error-list\#recursive-invocation-of-commands) [Copy link to section](https://vercel.com/docs/errors/error-list\#recursive-invocation-of-commands)

### [Why this error occurred](https://vercel.com/docs/errors/error-list\#why-this-error-occurred) [Copy link to section](https://vercel.com/docs/errors/error-list\#why-this-error-occurred)
...
### [Possible ways to fix it](https://vercel.com/docs/errors/error-list\#possible-ways-to-fix-it) [Copy link to section](https://vercel.com/docs/errors/error-list\#possible-ways-to-fix-it)
...
## [Pnpm engine unsupported](https://vercel.com/docs/errors/error-list\#pnpm-engine-unsupported) [Copy link to section](https://vercel.com/docs/errors/error-list\#pnpm-engine-unsupported)
...
## [Yarn dynamic require of "util" is not supported](https://vercel.com/docs/errors/error-list\#yarn-dynamic-require-of-util-is-not-supported) [Copy link to section](https://vercel.com/docs/errors/error-list\#yarn-dynamic-require-of-util-is-not-supported)
...
## [Invalid Edge Config connection string](https://vercel.com/docs/errors/error-list\#invalid-edge-config-connection-string) [Copy link to section](https://vercel.com/docs/errors/error-list\#invalid-edge-config-connection-string)
...
## [Globally installed `@vercel/speed-insights` or `@vercel/analytics` packages](https://vercel.com/docs/errors/error-list\#globally-installed-@vercel/speed-insights-or-@vercel/analytics-packages) [Copy link to section](https://vercel.com/docs/errors/error-list\#globally-installed-@vercel/speed-insights-or-@vercel/analytics-packages)
...
## [Oversized Incremental Static Regeneration page](https://vercel.com/docs/errors/error-list\#oversized-incremental-static-regeneration-page) [Copy link to section](https://vercel.com/docs/errors/error-list\#oversized-incremental-static-regeneration-page)
